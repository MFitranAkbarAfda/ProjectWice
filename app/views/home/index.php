                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo">
                              <a href="<?= BASEURL; ?>/home">
                                 <img src="<?= BASEURL; ?>/images/logo/WiceLogo.png" alt="#" />
                              </a>
                           </div>
                        </div>
                     </div>
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="service.html"><?= $data['nama'] ?></a>
                              </li>
                              <li class="nav-item">
                  ...
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="row d_flex">
                           <div class="col-md-6">
                              <div class="text-bg">
                                 <h1>World Invention Competition and Exhibition</h1>
                           ...
                           <div class="col-md-6">
                              <div class="text_img">
                                 <figure>
                                    <img src="<?= BASEURL; ?>/images/pct.png" alt="#"/>
                                    <h3>01</h3>
                                 </figure>
                              </div>
                           </div>
